...
\resph{https://simoxmenblog.blogspot.com/2024/06/smo-open-2024-speedrun.html}{Review by \textit{Glen}}
...
\solcit{https://simoxmenblog.blogspot.com/2024/06/smo-open-2024-speedrun.html}{Glen} Observe that the condition $p \nmid a_{ik}a_{jl} - a_{il}a_{jk}$ is equivalent to \[
\begin{vmatrix}
    a_{ik} & a_{il}\\
    a_{jk} & a_{jl}
