...
\begin{resources}
    Review by \resit{https://simoxmenblog.blogspot.com/2023/09/smo-open-2023-speedrun.html}{Glen Lim}, \res{https://artofproblemsolving.com/community/c3378422_2023_sinapore_mo_open}{AoPS threads}
\end{resources}

\begin{question}\label{Q::2023-O-2-1}
...
\begin{question}[Yes]\label{Q::2023-O-2-2}
    ...
    \end{enumerate}
\end{question}
\begin{solution*}[\credittt{https://artofproblemsolving.com/community/c6h3102143p28243581}{bxiao31415}]
...
\begin{question}\label{Q::2023-O-2-4}
    Find all functions $f : \ZZ \to \ZZ$, such that \[f(x+y)((f(x) - f(y))^2 + f(xy)) = f(x^3) + f(y^3)\] for all integers $x$, $y$.
\end{question}
\begin{solution*}[\credittt{https://artofproblemsolving.com/community/c6h3102144p28049134}{Ld\_minh4354}]
...
\begin{question}[$x \in {(0, 120]}$]\label{Q::2023-O-2-5}
...
\begin{solution*}[\credittt{https://artofproblemsolving.com/community/c6h3102149p28159955}{oneplusone}]
