...
\begin{resources}
    \res{https://artofproblemsolving.com/community/c3073907_2022_singapore_mo_open}{AoPS threads}
\end{resources}
...
\end{question}
\begin{solution*}[\credittt{https://artofproblemsolving.com/community/c6h2876083p25555460}{gghx}]
    \phantom{}
    \begin{center}
...
\begin{question}\label{Q::2022-O-2-2}
...
\end{question}
\begin{solution*}[\credittt{https://artofproblemsolving.com/community/c6h2876084p25568028}{sarjinius}]
    ...
    \case{2} Suppose $\lcm{k, l}$ is even. Then at least one of $k$ and $l$ is even (and also 2 mod 4). 
...
\end{question}
\begin{solution*}\credittt{https://artofproblemsolving.com/community/c6h2876085p25698517}{DVDthe1st}
...
\begin{question}[$n-\gcd{n, k}$]\label{Q::2022-O-2-4}
...
\end{question}
\begin{solution*}[\credittt{https://artofproblemsolving.com/community/c6h2876086p25568807}{gghx}]
...
\begin{question}\label{Q::2022-O-2-5}
...
\end{remark}
\begin{solution*}[\credit{https://artofproblemsolving.com/community/c6h2876088p28594891}{Evan Chen}]
