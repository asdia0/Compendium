...
\begin{enumerate}
    ...
    \hyperrefitem[A::2024-S-1-24] Find the number of positive integers $x < 9000$ such that $x^3 + 95$ is divisible by 96.
    \hyperrefitem[A::2024-S-1-25] A scalene triangle $\triangle ABC$ has sides $AB = 7$, $AC = 12$ and $BC = 13$. Write $\tan \frac{A-B}{2} \tan \frac{C}{2}$ as a fraction $\frac{m}{n}$ in its lowest form and find $m + n$.
