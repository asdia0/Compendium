...
\sol{1} By the difference of cubes identity, one has \[y - x = \bp{y^{1/3} - x^{1/3}}\bp{y^{2/3} + y^{1/3}x^{1/3} + x^{2/3}} = 12\bp{y^{2/3} + y^{1/3}x^{1/3} + x^{2/3}}.\] Substituting $y^{1/3} = x^{1/3} + 12$, we see that \[y^{2/3} + y^{1/3}x^{1/3} + x^{2/3} = 3x^{2/3} + 36x^{1/3} + 144 = 3\bp{x^{1/3} + 6}^2 + 36.\] Hence, $y - x \geq 12 \cdot 36 = 432$, with equality when $x^{1/3} = -6$.

\sol{2}[Abusing symmetry] Let $x_\ast = -x$. We wish to find the minimum value of $x_\ast + y$ subject to $x_\ast^{1/3} + y^{1/3} = 12$. By symmetry, this occurs when $x_\ast^{1/3} = y^{1/3} = 6$, thus $\min x_\ast + y = 6^3 + 6^3 = 432$.
